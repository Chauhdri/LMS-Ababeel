...
var ReactPasswordProps = function (_a) {
    ...
    var ruleDefinitions = {
        minLength: {
            ...
            message: messages.minLength || "Password has more than ".concat(minLength, " characters."),
        },
        specialChar: {
        ...
        maxLength: {
            ...
            message: messages.maxLength || "Password has no more than ".concat(maxLength, " characters."),
        },
        notEmpty: {
