...
var _Close2 = _interopRequireDefault(require("../internal/svg-icons/Close"));
...
const ChipDeleteRoot = (0, _styled.default)('button', {
  ...
  return [{
    ...
    [`&.${_chipDeleteClasses.default.disabled}`]: (_theme$variants$3 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants$3[ownerState.color]
  }];
});
...
const ChipDelete = /*#__PURE__*/React.forwardRef(function ChipDelete(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(ChipDeleteRoot, (0, _extends2.default)({
    as: component,
    className: (0, _clsx.default)(classes.root, className),
    ownerState: ownerState
  }, other, getRootProps(), {
    children: children != null ? children : _Close || (_Close = /*#__PURE__*/(0, _jsxRuntime.jsx)(_Close2.default, {}))
  }));
});
