...
const _excluded = ["action", "autoFocus", "children", "componentsProps", "defaultValue", "defaultListboxOpen", "disabled", "placeholder", "listboxId", "listboxOpen", "onChange", "onListboxOpenChange", "onClose", "renderValue", "value", "size", "variant", "color", "startDecorator", "endDecorator", "indicator", "aria-describedby", "aria-label", "aria-labelledby", "id", "name"],
...
const SelectRoot = (0, _styles.styled)('div', {
  ...
  var _theme$variants$, _theme$vars$palette, _theme$variants$2, _theme$variants$3;
  ...
  return [(0, _extends2.default)({
    ...
    [`&.${_selectClasses.default.disabled}`]: (_theme$variants$3 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants$3[ownerState.color]
  })];
});
...
const Select = /*#__PURE__*/React.forwardRef(function Select(inProps, ref) {
  ...
  const cachedModifiers = React.useMemo(() => {
    ...
    }, ...(((_componentsProps$list = componentsProps.listbox) == null ? void 0 : _componentsProps$list.modifiers) || [])];
  }, [(_componentsProps$list2 = componentsProps.listbox) == null ? void 0 : _componentsProps$list2.modifiers]);
  const {
    buttonActive,
    buttonFocusVisible,
    disabled,
  ...
  const _ref2 = componentsProps.listbox || {},
        {
    component: listboxComponent
  } = _ref2,
        externalListboxProps = (0, _objectWithoutPropertiesLoose2.default)(_ref2, _excluded2);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(React.Fragment, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(SelectRoot, (0, _extends2.default)({}, rootProps, {
      children: [startDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(SelectStartDecorator, {
      ...
      })), endDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(SelectEndDecorator, {
        className: classes.endDecorator,
        ownerState: ownerState,
        children: endDecorator
      }), indicator && /*#__PURE__*/(0, _jsxRuntime.jsx)(SelectIndicator, {
        className: classes.indicator,
        ownerState: ownerState,
        children: indicator
      })]
    })), anchorEl && /*#__PURE__*/(0, _jsxRuntime.jsx)(_PopperUnstyled.default, (0, _extends2.default)({}, listboxProps, {
