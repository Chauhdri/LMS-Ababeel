...
const _excluded = ["aria-describedby", "aria-label", "aria-labelledby", "autoComplete", "autoFocus", "className", "color", "component", "componentsProps", "defaultValue", "disabled", "endDecorator", "fullWidth", "error", "id", "name", "onClick", "onChange", "onKeyDown", "onKeyUp", "onFocus", "onBlur", "placeholder", "readOnly", "required", "type", "startDecorator", "size", "value", "variant"];
...
const useUtilityClasses = ownerState => {
  ...
  return (0, _composeClasses.default)(slots, _inputClasses.getInputUtilityClass, classes);
};
...
const InputRoot = (0, _styles.styled)('div', {
  ...
  return [(0, _extends2.default)({
    ...
    '&:hover': (0, _extends2.default)({}, (_theme$variants$2 = theme.variants[`${ownerState.variant}Hover`]) == null ? void 0 : _theme$variants$2[ownerState.color], {
      cursor: 'text'
    }),
    [`&.${_inputClasses.default.disabled}`]: (_theme$variants$3 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants$3[ownerState.color]
...
const Input = /*#__PURE__*/React.forwardRef(function Input(inProps, ref) {
  ...
  const rootStateClasses = {
    [_inputClasses.default.disabled]: disabledState,
    [_inputClasses.default.error]: errorState,
    [_inputClasses.default.focused]: focused,
    [_inputClasses.default.formControl]: Boolean(formControlContext)
  };
  ...
  const inputProps = (0, _utils2.useSlotProps)({
    ...
    additionalProps: {
      as: (_componentsProps$inpu = componentsProps.input) == null ? void 0 : _componentsProps$inpu.component
    },
    ownerState,
    className: [classes.input, inputStateClasses]
  });
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(InputRoot, (0, _extends2.default)({}, rootProps, {
    children: [startDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(InputStartDecorator, {
      className: classes.startDecorator,
      ownerState: ownerState,
      children: startDecorator
    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(InputInput, (0, _extends2.default)({}, inputProps)), endDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(InputEndDecorator, {
