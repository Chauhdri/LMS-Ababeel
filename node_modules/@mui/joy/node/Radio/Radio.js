...
const _excluded = ["checked", "checkedIcon", "className", "component", "componentsProps", "defaultChecked", "disabled", "disableIcon", "overlay", "label", "id", "name", "onBlur", "onChange", "onFocus", "onFocusVisible", "required", "color", "variant", "size", "uncheckedIcon", "value"];
...
const RadioRadio = (0, _styles.styled)('span', {
  ...
  return [(0, _extends2.default)({
    ...
    [`&.${_radioClasses.default.disabled}`]: (_theme$variants$3 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants$3[ownerState.color]
  }] : [])];
});
const RadioAction = (0, _styles.styled)('span', {
  ...
  return [{
    ...
    [`&.${_radioClasses.default.disabled}`]: (_theme$variants$6 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants$6[ownerState.color]
  }] : [])];
});
...
const Radio = /*#__PURE__*/React.forwardRef(function Radio(inProps, ref) {
  var _componentsProps$radi, _componentsProps$acti, _componentsProps$inpu, _componentsProps$labe;
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(RadioRoot, (0, _extends2.default)({
    ref: ref
  }, otherProps, {
    as: component,
    ownerState: ownerState,
    className: (0, _clsx.default)(classes.root, className),
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(RadioRadio, (0, _extends2.default)({}, componentsProps == null ? void 0 : componentsProps.radio, {
      ownerState: ownerState,
      className: (0, _clsx.default)(classes.radio, componentsProps == null ? void 0 : (_componentsProps$radi = componentsProps.radio) == null ? void 0 : _componentsProps$radi.className),
      children: [checked && !disableIcon && checkedIcon, !checked && !disableIcon && uncheckedIcon, !checkedIcon && !uncheckedIcon && !disableIcon && /*#__PURE__*/(0, _jsxRuntime.jsx)(RadioIcon, {
        ownerState: ownerState
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(RadioAction, (0, _extends2.default)({}, componentsProps == null ? void 0 : componentsProps.action, {
        ownerState: ownerState,
        className: (0, _clsx.default)(classes.action, componentsProps == null ? void 0 : (_componentsProps$acti = componentsProps.action) == null ? void 0 : _componentsProps$acti.className),
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(RadioInput, (0, _extends2.default)({
          ownerState: ownerState
        }, getInputProps((0, _extends2.default)({}, componentsProps.input, {
          ...
          name: name,
          value: String(value),
          className: (0, _clsx.default)(classes.input, (_componentsProps$inpu = componentsProps.input) == null ? void 0 : _componentsProps$inpu.className)
        }))
      }))]
    })), label && /*#__PURE__*/(0, _jsxRuntime.jsx)(RadioLabel, (0, _extends2.default)({}, componentsProps == null ? void 0 : componentsProps.label, {
      htmlFor: id,
      ownerState: ownerState,
      className: (0, _clsx.default)(classes.label, componentsProps == null ? void 0 : (_componentsProps$labe = componentsProps.label) == null ? void 0 : _componentsProps$labe.className),
...
= {
  ...
  componentsProps: _propTypes.default.shape({
    ...
    radio: _propTypes.default.object,
