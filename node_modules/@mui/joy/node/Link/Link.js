...
const _excluded = ["color", "textColor"],
      _excluded2 = ["className", "component", "children", "disabled", "onBlur", "onFocus", "level", "overlay", "underline", "variant", "endDecorator", "startDecorator"];
...
const LinkRoot = (0, _styled.default)('a', {
  ...
  var _theme$vars$palette, _theme$vars$palette2, _theme$vars$palette3, _theme$variants$owner, _theme$variants$, _theme$variants$2, _theme$variants$3;
  ...
  return [(0, _extends2.default)({
    ...
    [`&.${_linkClasses.default.disabled}`]: (_theme$variants$3 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants$3[ownerState.color]
  })];
});
const Link = /*#__PURE__*/React.forwardRef(function Link(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(LinkRoot, (0, _extends2.default)({
    ...
    children: [startDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(StartDecorator, {
      ownerState: ownerState,
      className: classes.startDecorator,
      children: startDecorator
    }), children, endDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(EndDecorator, {
      ownerState: ownerState,
