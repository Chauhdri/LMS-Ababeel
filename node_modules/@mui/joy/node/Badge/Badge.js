...
const _excluded = ["anchorOrigin", "badgeInset", "className", "component", "components", "componentsProps", "size", "color", "invisible", "max", "badgeContent", "showZero", "variant"];
...
const Badge = /*#__PURE__*/React.forwardRef(function Badge(inProps, ref) {
  ...
  const displayValue = max !== undefined && badgeContentProp && Number(badgeContentProp) > max ? `${max}+` : badgeContentProp;
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_BadgeUnstyled.default, (0, _extends2.default)({
    ...
    componentsProps: {
      ...
      badge: (0, _extends2.default)({}, componentsProps.badge, {
        className: (0, _clsx.default)(classes.badge)
