...
const _excluded = ["checked", "className", "component", "componentsProps", "defaultChecked", "disabled", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "id", "color", "variant", "size", "startDecorator", "endDecorator"];
...
const Switch = /*#__PURE__*/React.forwardRef(function Switch(inProps, ref) {
  var _componentsProps$star, _componentsProps$trac, _componentsProps$trac2, _componentsProps$thum, _componentsProps$acti, _componentsProps$inpu, _componentsProps$endD;
  ...
  return /*#__PURE__*/_jsxs(SwitchRoot, _extends({
    ref: ref
  }, otherProps, {
    as: component,
    ownerState: ownerState,
    className: clsx(classes.root, className),
    children: [startDecorator && /*#__PURE__*/_jsx(SwitchStartDecorator, _extends({
      "aria-hidden": "true"
    }, componentsProps.startDecorator, {
      ownerState: ownerState,
      className: clsx(classes.input, (_componentsProps$star = componentsProps.startDecorator) == null ? void 0 : _componentsProps$star.className),
      children: typeof startDecorator === 'function' ? startDecorator(ownerState) : startDecorator
    })), /*#__PURE__*/_jsxs(SwitchTrack, _extends({}, componentsProps.track, {
      ownerState: ownerState,
      className: clsx(classes.track, (_componentsProps$trac = componentsProps.track) == null ? void 0 : _componentsProps$trac.className),
      children: [(_componentsProps$trac2 = componentsProps.track) == null ? void 0 : _componentsProps$trac2.children, /*#__PURE__*/_jsx(SwitchThumb, _extends({}, componentsProps.thumb, {
        ownerState: ownerState,
        className: clsx(classes.thumb, (_componentsProps$thum = componentsProps.thumb) == null ? void 0 : _componentsProps$thum.className)
      }))]
    })), /*#__PURE__*/_jsx(SwitchAction, _extends({}, componentsProps.action, {
      ownerState: ownerState,
      className: clsx(classes.action, (_componentsProps$acti = componentsProps.action) == null ? void 0 : _componentsProps$acti.className),
      children: /*#__PURE__*/_jsx(SwitchInput, _extends({
        id: id
    ...
    })), endDecorator && /*#__PURE__*/_jsx(SwitchEndDecorator, _extends({
      "aria-hidden": "false"
    }, componentsProps.endDecorator, {
      ownerState: ownerState,
      className: clsx(classes.input, (_componentsProps$endD = componentsProps.endDecorator) == null ? void 0 : _componentsProps$endD.className),
