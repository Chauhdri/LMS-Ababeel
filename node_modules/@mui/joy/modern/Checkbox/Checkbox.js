...
const Checkbox = /*#__PURE__*/React.forwardRef(function Checkbox(inProps, ref) {
  ...
  return /*#__PURE__*/_jsxs(CheckboxRoot, _extends({
    ...
    children: [/*#__PURE__*/_jsxs(CheckboxCheckbox, _extends({}, componentsProps?.checkbox, {
      ownerState: ownerState,
      className: clsx(classes.checkbox, componentsProps.checkbox?.className),
      children: [/*#__PURE__*/_jsx(CheckboxAction, _extends({}, componentsProps?.action, {
        ownerState: ownerState,
        className: clsx(classes.action, componentsProps.action?.className),
        children: /*#__PURE__*/_jsx(CheckboxInput, _extends({}, componentsProps?.input, {
          ownerState: ownerState
      ...
      value: true,
      children: /*#__PURE__*/_jsx(CheckboxLabel, _extends({}, componentsProps?.label, {
        htmlFor: id,
        ownerState: ownerState,
