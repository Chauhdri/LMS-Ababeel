...
export declare const createTextOverrides: (theme: ThemeFragment) => Record<DefaultColorPalette, CSSObject>;
export declare const createContainedOverrides: (theme: ThemeFragment) => Record<DefaultColorPalette, CSSObject>;
export declare const createVariant: (variant: VariantKey, theme?: ThemeFragment | undefined) => Record<"context" | DefaultColorPalette, CSSObject>;
export {};
