...
export declare type DefaultContextualOverrides = `${DefaultVariantProp}Overrides`;
export declare type ContextualOverrideKeys = OverridableStringUnion<DefaultContextualOverrides, ContextualOverrides>;
...
declare type BaseContextOverrides = Record<DefaultContextualOverrides, Record<ColorPaletteProp, CSSObject>>;
