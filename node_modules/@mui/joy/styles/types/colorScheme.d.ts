 ...
 */
export declare type DefaultColorScheme = 'light' | 'dark';
/**
...
export declare type ExtendedColorScheme = OverridableStringUnion<never, ColorSchemeOverrides>;
/**
 * All color-schemes that the application has
 */
export declare type SupportedColorScheme = DefaultColorScheme | ExtendedColorScheme;
